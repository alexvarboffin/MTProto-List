...
public abstract class TemplateViewHolder extends RecyclerView.ViewHolder {
    ...
    public TemplateViewHolder(@NonNull View itemView) {
        ...
        primaryView = itemView.findViewById(R.id.primary);
        secondaryView = itemView.findViewById(R.id.secondary);
        tertiaryView = itemView.findViewById(R.id.body);

        ratingBar = itemView.findViewById(R.id.rating_bar);
        ratingBar.setEnabled(false);

        callToActionView = itemView.findViewById(R.id.cta);
