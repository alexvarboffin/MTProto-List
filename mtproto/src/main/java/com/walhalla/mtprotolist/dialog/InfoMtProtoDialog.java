...
public class InfoMtProtoDialog extends DialogFragment {

    private static final String KEY_ARG_DATA = "data";
    private InfoDialogBinding binding;

    public static InfoMtProtoDialog newInstance(MtprotoProxy data) {
        InfoMtProtoDialog dialog = new InfoMtProtoDialog();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        try {
            MtprotoProxy server = (MtprotoProxy) getArguments().getSerializable(KEY_ARG_DATA);
