...
//
//    fun getIpInfo(
//        serverList: MutableList<MtprotoProxy>,
//        callback: Callback<MutableList<MtprotoProxy?>?>
//    ) {
//        executor.execute(Runnable {
//            try {
//                val jsonArray = QueryFormat.getArray0(serverList)
...
//        callback: Callback<MutableList<ProxyInfo?>?>
//    ) {
//        executor.execute(Runnable {
//            try {
//                val jsonArray = QueryFormat.getQueryArray(serverList)
//                val JSON = MediaType.parse("application/json; charset=utf-8")
//                val requestBody = RequestBody.create(JSON, jsonArray.toString())
//
//                val request = Request.Builder()
...
//
//
//    fun setIpInfo(response: JSONArray, serverList: MutableList<MtprotoProxy>): Boolean {
//        var result = false
//
//        for (i in 0..<response.length()) {
//            try {
