...
//    public static final String START_FOREGROUND_ACTION = BuildConfig.APPLICATION_ID + ".action.startforeground";
//    public static final String STOP_FOREGROUND_ACTION = BuildConfig.APPLICATION_ID + ".action.stopforeground";
