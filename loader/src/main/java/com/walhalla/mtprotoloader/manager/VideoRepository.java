package com.walhalla.mtprotoloader.manager;//package com.walhalla.mtprotolist.manager;
...
//                }
                ...
                MtprotoProxy server = new MtprotoProxy(host, "" + port, matcher.group(3), code, enabled);
